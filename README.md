...
| ORIGINSTAT | OriginStatusID | Wellbore.1.4.0.json | [Link](https://community.opengroup.org/osdu/data/data-definitions/-/blob/master/Generated/master-data/Wellbore.1.4.0.json) | [Link](https://community.opengroup.org/osdu/data/data-definitions/-/blob/master/E-R/master-data/Wellbore.1.1.0.md) | Y |
| PARENTWELL | ParentWellID   | Wellbore.1.4.0.json | [Link](https://community.opengroup.org/osdu/data/data-definitions/-/blob/master/Generated/master-data/Wellbore.1.4.0.json) | [Link](https://community.opengroup.org/osdu/data/data-definitions/-/blob/master/E-R/master-data/Wellbore.1.1.0.md) | Y |
...
| SPUDDATE   | SpudDate       | Wellbore.1.4.0.json | [Link](https://community.opengroup.org/osdu/data/data-definitions/-/blob/master/Generated/master-data/Wellbore.1.4.0.json) | [Link](https://community.opengroup.org/osdu/data/data-definitions/-/blob/master/E-R/master-data/Wellbore.1.1.0.md) | Y |
| DATETDREAC | TDDate         | Wellbore.1.4.0.json | [Link](https://community.opengroup.org/osdu/data/data-definitions/-/blob/master/Generated/master-data/Wellbore.1.4.0.json) | [Link](https://community.opengroup.org/osdu/data/data-definitions/-/blob/master/E-R/master-data/Wellbore.1.1.0.md) | Y |
| COMPLEDATE | CompletionDate | Wellbore.1.4.0.json | [Link](https://community.opengroup.org/osdu/data/data-definitions/-/blob/master/Generated/master-data/Wellbore.1.4.0.json) | [Link](https://community.opengroup.org/osdu/data/data-definitions/-/blob/master/E-R/master-data/Wellbore.1.1.0.md) | Y |
| RELEASEDAT | ReleaseDate    | Wellbore.1.4.0.json | [Link](https://community.opengroup.org/osdu/data/data-definitions/-/blob/master/Generated/master-data/Wellbore.1.4.0.json) | [Link](https://community.opengroup.org/osdu/data/data-definitions/-/blob/master/E-R/master-data/Wellbore.1.1.0.md) | Y |
...
### Part 7 — OSDU Required Components Missing from NSTA

| OSDU Field         | Purpose / Notes                                      | OSDU Schema File         | .json URL | .md URL | OSDU Schema |
|--------------------|------------------------------------------------------|---------------------------|-----------|---------|-------------|
| id                 | Unique record identifier (UUID)                      | All master/work schemas   | N/A       | N/A     | Y |
| kind               | Schema type and version (e.g., `osdu:master-data:Well:1.0.0`) | All schemas | N/A       | N/A     | Y |
| acl                | Access control list (who can read/write)             | All schemas               | N/A       | N/A     | Y |
| legal              | Legal tags, data governance                          | All schemas               | N/A       | N/A     | Y |
| data               | Container for actual business fields                 | All schemas               | N/A       | N/A     | Y |
| meta               | Metadata about ingestion, versioning                | All schemas               | N/A       | N/A     | Y |
